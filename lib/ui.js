    ...
    config.features.forEach((feature, index) => {
        ...
        li.addEventListener("click", () => {
            if (li.classList.contains('topo-highlight')) {
                ...
                list_items = document.querySelectorAll('.feature-list-item');
...
function updateSVG() {
    try {
        displayConfigAsYAML();
        document.getElementById("svg-preview").innerHTML = new Draw(config).draw();
        addHightlightEvents();
    } catch (error) {
...
function setup() {
    ...
    document.getElementById('save-btn').addEventListener('click', function () {
        ...
        saveChangesToMediaWikiAPI(pageFullName, newYamlContent);
    });
...
let RW_DOMAIN = "https://ropewiki.attack-kitten.com";
