...
export function renderFeatureList() {
    ...
    window.topo.config.features.forEach((feature, index) => {
        ...
        if (feature.type === "line") {
            if (feature.sections && Array.isArray(feature.sections) && feature.sections.length > 0) {
                ...
                const convertToMultiBtn = document.createElement("button");
                convertToMultiBtn.textContent = "Convert to Multi-Section";
                convertToMultiBtn.addEventListener("click", () => {
                ...
                mainRow.appendChild(convertToMultiBtn);
            }
        }
