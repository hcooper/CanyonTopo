import {updateSVG, renderFeatureList} from './editor.js';
...
export function initializeSortable() {
  ...
  Sortable.create(featureList, {
    ...
    onEnd: function (/**Event*/ evt) {
      ...
      const movedItem = window.topo.config.features.splice(oldIndex, 1)[0];
      window.topo.config.features.splice(newIndex, 0, movedItem);
