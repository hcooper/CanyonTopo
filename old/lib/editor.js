...
export function renderFeatureList() {
    ...
    window.topo.config.features.forEach((feature, index) => {
        ...
        // Track sections container if feature has sections
        ...
        if (feature.type === "line") {
            ...
            if (feature.sections && Array.isArray(feature.sections)) {
                ...
                sectionsContainer.style.marginTop = "5px";

                feature.sections.forEach((section, sectionIndex) => {
                    const sectionRow = document.createElement("div");
                    sectionRow.style.marginBottom = "3px";
                    ...
                    sectionRow.appendChild(document.createTextNode("Length: "));
                    sectionRow.appendChild(lengthInput);
                    sectionRow.appendChild(document.createTextNode(" Slope: "));
                    sectionRow.appendChild(slopeInput);
        ...
        if (sectionsContainer) {
            li.appendChild(sectionsContainer);
        }
